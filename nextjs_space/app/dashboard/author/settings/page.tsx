  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand/5 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4 md:p-6">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-brand to-military-600 bg-clip-text text-transparent flex items-center gap-2">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Button 
                    ...
                    disabled={loading}
                    className="bg-gradient-to-r from-brand to-military-700"
                  >
                    {loading ? (
