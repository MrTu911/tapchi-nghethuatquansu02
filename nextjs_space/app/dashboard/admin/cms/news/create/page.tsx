      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b mb-6">
        <div className="flex items-center justify-between px-1 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-semibold">Tạo tin tức mới</h1>
              {formData.title && (
          ...
          <Card className="shadow-sm">
            <CardContent className="pt-5">
              <div className="flex items-center gap-2 mb-4">
                <Tabs value={lang} onValueChange={(v) => setLang(v as 'vi' | 'en')}>
                  <TabsList className="h-8">
                    <TabsTrigger value="vi" className="text-xs px-3">🇻🇳 Tiếng Việt</TabsTrigger>
