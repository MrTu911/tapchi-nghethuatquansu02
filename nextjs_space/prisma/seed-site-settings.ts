...
const defaultSettings = [
  ...
  },
  {
    ...
    value: 'Giấy phép hoạt động báo chí số 619/GP-BTTTT do Bộ Thông tin và Truyền thông cấp ngày 23-12-2020.',
    label: 'Dòng giấy phép',
    labelEn: 'License Text',
    type: 'textarea',
    placeholder: 'Giấy phép hoạt động báo chí số...',
    helpText: 'Thông tin giấy phép hoạt động báo chí hiển thị ở footer.',
    order: 5,
  },
  {
    category: 'footer',
    key: 'footer_print_text',
    value: 'In tại Xưởng in Học viện Quốc phòng.',
    label: 'Dòng nơi in',
    labelEn: 'Printing Place',
    type: 'text',
    placeholder: 'In tại...',
    helpText: 'Thông tin nơi in ấn hiển thị ở footer.',
    order: 6,
  },
  {
    category: 'footer',
    key: 'footer_pobox_text',
    value: 'Hòm thư: 2EA6 – Hà Nội.',
    label: 'Dòng hòm thư',
    labelEn: 'P.O. Box',
    type: 'text',
    placeholder: 'Hòm thư: ...',
    helpText: 'Thông tin hòm thư hiển thị ở footer.',
    order: 7,
  },
  {
    category: 'footer',
    ...
    label: 'Cột chuyên mục (footer)',
    labelEn: 'Footer Categories',
    type: 'json',
    placeholder: '',
    helpText: 'Danh sách liên kết chuyên mục hiển thị ở cột "Chuyên Mục" trong footer. Mỗi mục gồm label và href.',
    order: 8,
  },
  {
    category: 'appearance',
    key: 'appearance_banner_desktop',
    value: '/banner-pc.png',
    label: 'Banner (Desktop)',
    labelEn: 'Banner (Desktop)',
    type: 'image',
    placeholder: '/banner-pc.png',
    helpText: 'Ảnh banner đầu trang cho màn hình lớn. Tỷ lệ ngang, ~1280×240px.',
    order: 10,
  },
  {
    category: 'appearance',
    key: 'appearance_banner_tablet',
    value: '/banner-tablet.png',
    label: 'Banner (Tablet)',
    labelEn: 'Banner (Tablet)',
    type: 'image',
    placeholder: '/banner-tablet.png',
    helpText: 'Ảnh banner đầu trang cho máy tính bảng. ~1024×192px.',
    order: 11,
  },
  {
    category: 'appearance',
    key: 'appearance_banner_mobile',
    value: '/banner-mobile.png',
    label: 'Banner (Mobile)',
    labelEn: 'Banner (Mobile)',
    type: 'image',
    placeholder: '/banner-mobile.png',
    helpText: 'Ảnh banner đầu trang cho điện thoại. Hiển thị trọn logo + tên, ~768×120px.',
    order: 12,
  },
