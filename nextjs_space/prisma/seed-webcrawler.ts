...
const WEB_SOURCES = [
  ...
  },
  {
    ...
    url: 'https://hocvienhaucan.edu.vn/tin-tuc',
  ...
  const articles = [
    {
      ...
      rawDate: '15/04/2026',
      rawImageUrls: ['https://hocvienhaucan.edu.vn/storage/app/media/news1.jpg'],
    ...
    },
    {
      ...
      rawDate: '12/04/2026',
      rawImageUrls: ['https://hocvienhaucan.edu.vn/storage/app/media/ai-hc.jpg'],
    ...
    },
    {
      ...
      rawDate: '20/04/2026',
      rawImageUrls: ['https://hocvienhaucan.edu.vn/storage/app/media/50nam.jpg'],
