/**
 * seed-podcasts.ts — Tạp chí Nghệ thuật Quân sự Việt Nam
 *
...
const PODCAST_DATA: PodcastDef[] = [
  // ── Season 1: Hậu cần & Chiến tranh hiện đại ───────────────────────────────
  {
    ...
    description: 'Khám phá hệ thống tư duy và ra quyết định trong công tác bảo đảm hậu cần hiện đại. Làm thế nào các sĩ quan tham mưu phân tích tình huống, dự báo nhu cầu và điều phối nguồn lực trong thời gian thực?',
    host: 'Học viện Quốc phòng',
    category: 'Khoa học quân sự',
