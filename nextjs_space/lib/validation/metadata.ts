...
export const metadataSchema = z.object({
  ...
  doi: z.string().regex(/^10\.\d{4,}\/[^\s]+$/, 'DOI không hợp lệ (ví dụ: 10.59386/ntqs.2025.123)').optional().or(z.literal('')),
